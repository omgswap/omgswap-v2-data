...
function GlobalPage() {
  ...
  return (
    <PageWrapper>
      <ThemedBackground backgroundColor={transparentize(0.75, '#009685')} />
      <ContentWrapper>
        <div>
          <AutoColumn gap="24px" style={{ paddingBottom: below800 ? '0' : '24px' }}>
            <TYPE.largeHeader>{below800 ? 'OMGSwap Analytics' : 'Omega Protocol - OMGSwap Analytics'}</TYPE.largeHeader>
            <Search />
            <GlobalStats />
          </AutoColumn>
