...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#069385' : 'black',

  concreteGray: darkMode ? '#292C2F' : '#C2CECE',
  inputBackground: darkMode ? '#1F1F1F' : '#C2CECE',
  shadowColor: darkMode ? '#000' : '#069386',
  mercuryGray: darkMode ? '#333333' : '#E1E1E1',

  text1: darkMode ? '#C2CECE' : '#1F1F1F',
  ...
  onlyLight: darkMode ? '#171818' : 'transparent',
  divider: darkMode ? 'rgba(43, 43, 43, 0.435)' : 'rgba(43, 43, 43, 0.035)',

  //primary colors
  primary1: darkMode ? '#069385' : '#069385',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#069385',

  // secondary colors
  secondary1: darkMode ? '#069385' : '#069385',
  secondary2: darkMode ? '#17000b26' : '#F6DDE8',
  secondary3: darkMode ? '#17000b26' : '#FDEAF1',

  shadow1: darkMode ? '#000' : '#069386',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #06938530 0%, #fff 0%)`
})
